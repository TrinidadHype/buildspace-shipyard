...
const tokenName = "BUILDR";
const tokenSymbol = "BLDR";
const tokenDescription = "The ultimate token for buildoors";
const tokenImagePath = "tokens/bld/assets/hammer.jpg";
const tokenImageFileName = "hammer.jpg";
